...
- **ioboard/** — power, relay outputs, digital inputs, analog I/O, RS485, RS232.
  ...
  lives entirely on this board. `power.kicad_sch`, `digital_inputs.kicad_sch`, and
  `relay_outputs.kicad_sch` are captured; the rest of this board's subsystems are added
  as their own build plans reach schematic capture.
